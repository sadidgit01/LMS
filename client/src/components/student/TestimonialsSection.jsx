                ...
                <div className='flex gap-0.5'>
                  {[...Array(5)].map((_, i) => (
                    <img
                      className="h-5"
                      key={i}
                      src={i < Math.floor(testimonial.rating) ? assets.star : assets.star_blank} // if the index is less than the rating, then display the star, else display the blank star
                      alt="star"
                    />
                  ))}
                </div>
