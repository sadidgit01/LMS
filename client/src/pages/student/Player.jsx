...
import { assets } from '../../assets/assets'; // Importing assets for icons
import humanizeDuration from 'humanize-duration'; // Importing humanize-duration for lecture duration formatting
