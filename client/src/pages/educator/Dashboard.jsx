...
const fetchDashboardData = async () => {
   ...
   //here this function is used to fetch the data from the dummyDashboardData.js file and set it to the dashboardData state variable.
            ...
            <div>
              ...
              <tbody className="text-sm text-gray-500">
                {dashboardData.enrolledStudentsData.map((item, index) => (  
                            //enrolledStudentsData has been created in dummyDashboardData.js 
